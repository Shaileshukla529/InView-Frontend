...
type UserProfileData = {
  ...
  designation: string;
  avatar: string | null;
  date_of_birth: string | null; // as ISO string
  is_active: boolean;
  joining_date: string; // as ISO string
...
export function MyProfile({ open, onOpenChange }: UserProfileProps) {
    ...
    if (open) {
      const fetchUserData = async () => {
        ...
        try {
          ...
          setUserData(data);
          setProfileForm(data); // Initialize form with fetched data
        } catch (error) {
              ...
              <div className="flex items-start justify-between">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div className="flex-1">
                    <DialogTitle className="text-xl sm:text-[24px] md:text-[28px] tracking-tight">{profileForm.name}</DialogTitle>
                    <DialogDescription className="sr-only">
                      View and edit your profile information and security settings
                    </DialogDescription>
                    <p className="mt-1 text-xs sm:text-[13px] text-muted-foreground">{profileForm.email}</p>
            ...
            <div className="p-4 sm:p-6">
              ...
              {activeTab === 'profile' && (
                <div className="space-y-4 sm:space-y-6">
                  ...
                  {/* Account Statistics (Still static, but could be fetched) */}
                  <Card className="border-2 p-4 sm:p-6 shadow-sm transition-shadow duration-200 hover:shadow-md">
                    <div className="mb-4 sm:mb-6 flex items-center gap-3">
